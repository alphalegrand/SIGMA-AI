...
const BOT_NAME = "SIGMA";
const DEFAULT_THUMBNAIL = "https://files.catbox.moe/9ub5yy.jpeg";
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/256755457868", // link to bot or business
